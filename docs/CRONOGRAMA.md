...
| **U3** | Entrega Final | Team Topologies, IA em Processos |
...
| Data | Dia | Tipo | Atividade |
|------|-----|------|-----------|
| 05/05 | Ter | 🟢 | Cultura DevOps: o que é, o que NÃO é, CALMS, CI/CD |
| 07/05 | Qui | 🟢 | **🧩 Quiz 1** (Modelos + Scrum + Manifesto Ágil, **Multiprova 24h**, 25 min) |
